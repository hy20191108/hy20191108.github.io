...
### SNPD2023-Winterと論文誌の関係

- **SNPD2023-Winter会議論文**（2023年12月、Taichung, Taiwan）と**論文誌**（Networking and Parallel/Distributed Computing Systems, Vol.18, pp.137-152, April 2024）は**別々の業績として記載する**
- 会議で発表後、論文誌として別に出版されたため、重複ではない
- 両者は同じDOI（10.1007/978-3-031-53274-0_10）を持つが、これはSpringer書籍シリーズとして出版されたため
- **SNPD2023-Winter会議論文集のページ番号は不明**（PMANにも記載なし）
